...
async function run() {
    ...
    let lightBot = null;
    try {
        lightBot = new _bot__WEBPACK_IMPORTED_MODULE_1__.Bot(options, new _options__WEBPACK_IMPORTED_MODULE_2__.OpenAIOptions(options.openaiLightModel, options.lightTokenLimits));
    }
    catch (e) {
    ...
    let heavyBot = null;
    try {
        heavyBot = new _bot__WEBPACK_IMPORTED_MODULE_1__.Bot(options, new _options__WEBPACK_IMPORTED_MODULE_2__.OpenAIOptions(options.openaiHeavyModel, options.heavyTokenLimits));
    }
    catch (e) {
